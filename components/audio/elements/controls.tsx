...
export function AudioControls({ className, ...props }: AudioControlsProps) {
  const { isPlaying, isLoading, isBuffering, playbackState, currentMusic, isEngineInitialized, play, pause } =
    useAudio()
  ...
  return (
    <TooltipProvider delayDuration={100}>
      ...
      >
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="ghost" size="icon" onClick={handleNext} disabled={disableNext} aria-label="Next Track">
